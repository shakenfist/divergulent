...
| 4. LLM triage tier | [PLAN-patch-classification-phase-04-llm-triage.md](PLAN-patch-classification-phase-04-llm-triage.md) | **Implemented** — claim-blind triage + adversarial verify + ledger precedence + signed human review; operational run is the operator's budgeted step |
