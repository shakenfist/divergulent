...
- **Nine more found and fixed by the phase-7 pre-push audit**, one commit per
  finding on `patch-classification-audit-fixes`: the security-risk gate bypassed
