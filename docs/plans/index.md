...
| [PLAN-full-machine-run.md](PLAN-full-machine-run.md) | 1. Tier 1 polite default overview ✓ · 2. Tier 2 `--classify` via apt ✓ · 3. CI full-run sample output | Phases 1–2 complete | Make a full-machine run polite and viable via tiered patch data (cheap count overview, opt-in apt-source classification, per-package deep dive), proven by a CI full score of a Debian 13 runner. |
