...
| [PLAN-faster-full-run.md](PLAN-faster-full-run.md) | 1. Per-host rate-limit tuning ✓ · 2. Repology bulk staleness · 3. Progress reporting | Phase 1 complete | Make a cold full-machine run fast (per-host rate tuning + Repology bulk staleness) and legible (live progress), without becoming a worse API citizen. |
