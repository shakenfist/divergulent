...
| [PLAN-release-1.0.md](PLAN-release-1.0.md) | Publish (cache phase 5) ⋯ · Multi-release build matrix ⋯ · Trust hardening ⋯ · No-cry-wolf validation ⋯ · Privacy docs ⋯ · Robustness ⋯ · Release mechanics ⋯ | Tracking | The road to a 1.0 release: a living checklist of what must hold before divergulent earns a 1.0 tag — the published cache working by default across a Debian 11/12/13/testing/unstable build matrix, verified trust, validated honesty, and a stated privacy model. |
