...
| Phase | Plan | Status |
|-------|------|--------|
| 1. Per-host rate-limit tuning | PLAN-faster-full-run-phase-01-rate-limits.md | Not started |
| 2. Repology bulk staleness | PLAN-faster-full-run-phase-02-repology-bulk.md | Not started |
